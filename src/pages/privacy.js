...
const PrivacyPage = () => (
  <Layout>
    ...
    <p>
      NYHYPE ("us", "we", or "our") operates the hyhype.org website (hereinafter
    ...
    <p>
      ...
      have associated with that data. Our Privacy Policy for NYHYPE is created
    ...
    <p>NYHYPE uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>
      NYHYPE will take all steps reasonably necessary to ensure that your data
    ...
    <p>
      NYHYPE may disclose your Personal Data in the good faith belief that such
      action is necessary to:
    </p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of NYHYPE</li>
      <li>
    ...
    <ul>
      <li>
        ...
        <Link to="/contact/">https://nyhype.org/contact/</Link>
      </li>
    </ul>
  </Layout>
)
